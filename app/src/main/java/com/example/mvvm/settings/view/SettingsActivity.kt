...
//        setAppLocale(getSharedPreferences(Constants.SHARED_PREF_SETTINGS_LANGUAGE, Context.MODE_PRIVATE).getString(Constants.LANGUAGE,"en")!!)
        ...
        sharedPref = getSharedPreferences(Constants.SHARED_PREF_SETTINGS, MODE_PRIVATE)
        langBtnListener()
    }
...
//            //saveNewLang("ar")
//            binding.celsiusBtn.setBackgroundResource(R.drawable.btn_pressed)
//        }
//        binding.enLangBtn.setOnClickListener {
//            //saveNewLang("en")
//            binding.fahrenheitBtn.setBackgroundResource(R.drawable.btn_unpressed)
//        }
...
//        if (sharedPref.getString(Constants.LANGUAGE_SETTINGS, "en").toString() != newLang){
